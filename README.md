...
- **[insight-app/](insight-app/README.md)** — GSI listener + draft detector; parses game state and pushes updates to the backend
- **cv/** — Python screen-capture draft detector, spawned by `insight-app`
...
- Python 3.10+ with `cv/requirements.txt` installed (OpenCV, MSS, NumPy) — required for draft detection
