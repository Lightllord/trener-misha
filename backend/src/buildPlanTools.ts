...
export const tools: OpenAI.ChatCompletionTool[] = [
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Доля матчей на этом герое (STRATZ), где куплен каждый из перечисленных предметов, и их винрейт. Используй для ситуативных предметов-кандидатов, которых нет в топ-5 стандартного билда — отсекай те, что покупают крайне редко (rare: true).",
      parameters: {
        type: "object",
        properties: {
